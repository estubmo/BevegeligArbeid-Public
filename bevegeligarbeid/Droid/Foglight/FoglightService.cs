...
namespace Arbeidsvarsling.Droid.Foglight
{
    ...
    using global::Foglight.Xamarin.Android;
    ...
    public class FoglightService : IFoglightService, IDisposable
    {
        ...
        private IFoglightEventArgs Process(Tuple<object, BevegeligArbeid.Location.LocationUpdatedEventArgs> t)
        {
            ...
            System.Diagnostics.Debug.WriteLine("Foglight processing {0}", args.Location.Latitude);
            System.Diagnostics.Debug.WriteLine("Foglight processing {0}", args.Location.Longitude);
            System.Diagnostics.Debug.WriteLine("Foglight processing {0}", args.Location);

            GpsCoordinates coords = new GpsCoordinates(lat, @long, args.Location.HorizontalAccuracy, args.Location.VerticalAccuracy);
            System.Diagnostics.Debug.WriteLine("Foglight processing {0}", lat);
            System.Diagnostics.Debug.WriteLine("Foglight processing {0}", @long);
            System.Diagnostics.Debug.WriteLine("Foglight coords", coords);
